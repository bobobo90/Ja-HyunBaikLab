Tx = readtable('Figure 4h.xlsx', 'Range','A:A');  %Extracted normalized delta F/F data from pmat
...
Ty = readtable('Figure 4h.xlsx', 'Range','B:AN');  %Extracted normalized delta F/F data from pmat
Yz = table2array(Ty);
...
Ysum = horzcat(Y1normal,Y2normal,Y3normal,Y4normal,Y5normal,Y6normal,Y7normal,Y8normal,Y9normal,Y10normal,Y11normal,Y12normal,Y13normal,Y14normal,Y15normal,Y16normal,Y17normal,Y18normal,Y19normal,Y20normal,Y21normal,Y22normal,Y23normal,Y24normal,Y25normal,Y26normal,Y27normal,Y28normal,Y29normal,Y30normal,Y31normal,Y32normal,Y33normal,Y34normal);
Ymean = mean (Ysum, 2);
Ymean = mean (Ysum, 2);
Ystd = std(Ysum, 1 ,2);
Ystd = Ystd/sqrt(34);
