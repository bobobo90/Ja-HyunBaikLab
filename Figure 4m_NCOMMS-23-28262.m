Tx = readtable('Figure 4n.xlsx', 'Range','A:A');  %Extracted normalized delta F/F data from pmat
...
Ty = readtable('Figure 4n.xlsx', 'Range','B:S');  %Extracted normalized delta F/F data from pmat
Yz = table2array(Ty);
...
Ysum = horzcat(Y1normal,Y2normal,Y3normal,Y4normal,Y5normal,Y6normal,Y7normal,Y8normal,Y9normal,Y10normal,Y11normal,Y12normal,Y13normal,Y14normal,Y15normal,Y16normal,Y17normal,Y18normal,Y19normal,Y20normal,Y21normal,Y22normal,Y23normal);
Ymean = mean (Ysum, 2);
Ymean = mean (Ysum, 2);
Ystd = std(Ysum, 1 ,2);
Ystd = Ystd/sqrt(23);
