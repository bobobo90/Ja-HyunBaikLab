...
------------------------------------------------------------------------------------------------------------------------------------------------------
Tx = readtable('Demo data.xlsx', 'Range','A:A');  %Extracted normalized delta F/F data from pmat
...
Ty = readtable('Demo data.xlsx', 'Range','B:AN');  % Each column containing raw data of 'eating trials'
Yz = table2array(Ty);                                 
...
Ystd = Ystd/sqrt(39); 
f1= figure;
errorbar(Xz,Ymean,Ystd, 'Color','#DEC1DE','LineWidth',1.5,... 
                 'LineStyle', '-');
...
plot (Xz, Ymean, 'Color','#6937a1','LineWidth',2,...
                 'LineStyle', '-');
xline(0,'--r');
yline(0,'-');
title('Demo data')
